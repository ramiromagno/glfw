...
[![CRAN status](https://www.r-pkg.org/badges/version/glfw)](https://CRAN.R-project.org/package=glfw)
...
`{glfw}` depends on the [GLFW](https://www.glfw.org/) C library. Install it
first before trying to install `{glfw}`.
