# Original source: https://learnopengl.com/code_viewer_gh.php?code=src/1.getting_started/4.2.textures_combined/textures_combined.cpp
...
fs <- system.file("tutorials/learnopengl/textures/texture2.fs", package = "glfw")
