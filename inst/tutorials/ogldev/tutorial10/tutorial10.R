...
window <- glfw_create_window(width, height, "Tutorial 10: indexed draws")
...
g_world_location <-
  compile_shaders(
    vs_file = system.file("tutorials/ogldev/tutorial10/shader.vs", package = "glfw"),
    fs_file = system.file("tutorials/ogldev/tutorial10/shader.fs", package = "glfw")
  )
