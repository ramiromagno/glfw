...
window <- glfw_create_window(width, height, "Tutorial 04: shaders")
...
compile_shaders(
  vs_file = system.file("tutorials/ogldev/tutorial04/shader.vs", package = "glfw"),
  fs_file = system.file("tutorials/ogldev/tutorial04/shader.fs", package = "glfw")
)
