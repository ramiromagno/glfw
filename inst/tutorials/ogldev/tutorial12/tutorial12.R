...
window <- glfw_create_window(width, height, "Tutorial 12: perspective projection")
...
g_world_location <-
  compile_shaders(
    vs_file = system.file("tutorials/ogldev/tutorial12/shader.vs", package = "glfw"),
    fs_file = system.file("tutorials/ogldev/tutorial12/shader.fs", package = "glfw")
  )
